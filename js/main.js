...
document.addEventListener('DOMContentLoaded', function() {
  ...
  window.addEventListener('scroll', function() {
    if (window.scrollY > 100) { 
      logo.src = "https://eloirdiwi.free.nf/images/logo.png";
    } else {
      logo.src = "https://eloirdiwi.free.nf/images/logo white.png";
    }
  });
});
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (isHomePage) {
        const titles = ["Aymane Eloirdiwi", "Graphic Designer In Casablanca", "Logo & Identity Design"];
        let currentIndex = 0;
